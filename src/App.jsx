    ...
    <>
      <div class="bg-zinc-800">
        <div class="flex items-center justify-center h-screen">
            <div class="w-full px-4 py-8 mx-auto shadow lg:w-2/4  bg-zinc-500">
                <div class="flex items-center mb-6">
                    <h1 class="mr-6 text-4xl font-bold text-indigo-800"> To-Do Project |Fateme shafiee</h1>
                </div>
                <div class="relative">
                    <input type="text" placeholder="What needs to be done today?"
                    class="w-full px-2 py-3 border rounded outline-none border-grey-600 bg-gray-600" />
                </div>
                <ul class="list-reset ">
